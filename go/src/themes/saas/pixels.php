  	...
  	<?php echo $this->ads(728) ?>
		...
		<div class="main-content panel panel-default panel-body">
	        ...
	        <div class="row">
	        	<div class="col-md-4">
	        		<div class="form-group">
	        			...
	        			<select name="type" id="type">
	        				<option value="gtm"><?php echo e("Google Tag Manager") ?></option>
				...
				<hr>	
			<?php endif ?>
			<?php if(is_array($gtmpixel) && !empty($gtmpixel)): ?>
				<h3><?php echo e("Google Tag Manager") ?></h3>
				<?php foreach ($gtmpixel as $id => $gtm): ?>
					<form action="<?php echo Main::href("user/pixels/save?id={$id}") ?>" method="post">
		        <div class="form-group">	
							<div class="row">
								<div class="col-sm-4">
									<label class="control-label"><?php echo e("Name")?></label>
									<input type="text" value="<?php echo $gtm["name"] ?>" name="gtmpixel[name]" class="form-control" placeholder="e.g. Shopify Campaign" />
								</div>						
								<div class="col-sm-4">
									<label class="control-label"><?php echo e("Tag")?></label>		
									<input type="text" value="<?php echo $gtm["tag"] ?>" name="gtmpixel[tag]" class="form-control" placeholder="e.g. 1234567890123456" />
								</div>						
								<div class="col-sm-4">
									<div class="btn-group addmargin">
										...
										<?php if (!$this->isTeam() || ($this->isTeam() && $this->teamPermission("pixels.delete"))): ?>
											<a href="<?php echo Main::href("user/pixels/delete?id={$id}&type=gtmpixel") ?>" class="btn btn-default delete"><i class="fa fa-trash"></i></a>
										<?php endif ?>
									</div>
								</div>
							</div>
	        	...
	        	<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="btn-group addmargin">
										<button type="submit" class="btn btn-success"><?php echo e("Save") ?></button>
										<a href="<?php echo Main::href("user/pixels/delete?id={$id}&type=linkedinpixel") ?>" class="btn btn-danger delete"><?php echo e("Delete") ?></a>
									</div>
								</div>												
							</div>
		        </div>				
		        ...
		        <div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="btn-group addmargin">
										<button type="submit" class="btn btn-success"><?php echo e("Save") ?></button>
										<a href="<?php echo Main::href("user/pixels/delete?id={$id}&type=twitterpixel") ?>" class="btn btn-danger delete"><?php echo e("Delete") ?></a>
									</div>
								</div>																			
							</div>
		        </div>			
		        ...
		        <div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="btn-group addmargin">
										<button type="submit" class="btn btn-success"><?php echo e("Save") ?></button>
										<a href="<?php echo Main::href("user/pixels/delete?id={$id}&type=adrollpixel") ?>" class="btn btn-danger delete"><?php echo e("Delete") ?></a>
									</div>
								</div>
							</div>
		        </div>
		        ...
		        <div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="btn-group addmargin">
										<button type="submit" class="btn btn-success"><?php echo e("Save") ?></button>
										<a href="<?php echo Main::href("user/pixels/delete?id={$id}&type=quorapixel") ?>" class="btn btn-danger delete"><?php echo e("Delete") ?></a>
									</div>
								</div>
							</div>
		        </div>
