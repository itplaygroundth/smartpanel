              ...
              <div class="table-inner text-center">    
                ...
                <ul class="feature-list">
                  ...
                  <?php if ($plan["permission"]->team->enabled): ?>
                    <li><i class="glyphicon glyphicon-ok"></i> <span><strong><?php echo ($plan["permission"]->team->count == "0" ? e("Unlimited") : $plan["permission"]->team->count) ?></strong>  <?php echo e("Team Member"); ?></span></li>
                  <?php else: ?>
                    <li class="disabled"><i class="glyphicon glyphicon-remove"></i> <span><?php echo e("Team Member"); ?></span></li>                
                  <?php endif ?>                     
