  ...
  <div id="user-content" class="col-md-8">  	
  	<?php echo $this->ads(728) ?>
		...
		<div class="main-content panel panel-default panel-body">
			...
			<form action="<?php echo Main::href("user/settings") ?>" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label class="col-sm-3 control-label"><?php echo e("Avatar")?></label>			
					<div class="col-sm-9">
        ...
        <div class="form-group">
					<label class="col-sm-3 control-label"><?php echo e("Name")?></label>			
					<div class="col-sm-9">
