...
<div class="page-header">
  <h1 class="page-title">
    ...
    ?>
    <a href="<?=cn("$module/add")?>" class="ajaxModal"><span class="add-new" data-toggle="tooltip" data-placement="bottom" title="<?=lang("add_new")?>" data-original-title="Add new"><i class="fa fa-plus-square text-primary" aria-hidden="true"></i></span></a> 
    <?php }?>
    <?=lang("Creditcard")?>
  </h1>
