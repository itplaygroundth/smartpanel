...
<div class="row justify-content-md-center">
    <form id="paymentFrm" class="form omisepayForm" method="post" id="checkout" action="<?=cn($module."/omise/process")?>"
        ...
        <div class="container  justify-content-center">
            ...
            <h1 class="page-title"><?=lang("payment type")?></h1> 
                </div>
                <div class="">
                    <div class="card-header d-flex align-items-center">
                        <input type="radio" class="mr-5" id="payment_method1" value="truewallet" name="payment_method">
                        <h1 class="page-title">
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <h1 class="page-title"><i class="fa fa-credit-card-alt fa-2x text-primary" aria-hidden="true"></i>
                            <?=lang("Credit Card")?>
                        </h1>
                        ...
                        <div id="add_credit" class="hidden">
                            ...
                            <div class="form-container">
                                <div class="field-container">
                                    ...
                                    <input id="name" name="cardholder" class="form-control" maxlength="20" type="text">
                                </div>
                                <div class="field-container">
                                    <label class="form-label" for="cardnumber">Card Number</label>
                                    <!-- <span id="generatecard">generate random</span> -->
                                    <input id="cardnumber" name="cardnumber" class="form-control card-number" type="text" pattern="\d*" inputmode="numeric" >
                                ...
                                <div class="field-container">
                                    <label class="form-label" for="expirationdate">Expiration</label>
                                    <input id="expirationdate"  name="cardexpire" class="form-control" type="text" pattern="[0-9]*" inputmode="numeric">
                                </div>
                                <div class="field-container">
                                    <label class="form-label" for="securitycode">Security Code</label>
                                    <input id="securitycode" name="cardccv" class="form-control" type="text"  pattern="[0-9]*" inputmode="numeric">
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="card-header d-flex align-items-center">
                            ...
                            <h1 class="page-title"><i class="pr-2 fa fa-qrcode fa-2x text-primary" aria-hidden="true"></i>
                                <?=lang("qrcode")?></h1>
                        </div>
